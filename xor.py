...
with open('portas logicas/customXOR.csv', 'r', encoding='utf-8-sig') as file:
...
# Define a função de derivada da sigmoid
...
for i in range(epochs):
    ...
    layer2_error = y.reshape(-1, 1) - layer2_output
...
for i in range(len(X)):
    print("X = {}, y = {}, predicted y = {:.4f}".format(X[i], y[i], output[i][0]))